...
class ProductoPolicy
{
     ...
     * @return mixed
     */
    public function view(User $user, Productos $producto)
    {
     ...
     * @return mixed
     */
    public function update(User $user, Productos $producto)
    {
        return $user->id == $producto->user_id;
    }
     ...
     * @return mixed
     */
    public function delete(User $user, Productos $producto)
    {
        return $user->id == $producto->user_id;
    }
